 ...
 */
class moodle1_mod_embeddedvideopage_handler extends moodle1_resource_successor_handler {
    ...
    public function process_legacy_resource(array $data, array $raw = null) {
        ...
        $this->fileman = $this->converter->get_file_manager($contextid, 'mod_embeddedvideopage');
        ...
        // write page.xml
        $this->open_xml_writer("activities/page_{$moduleid}/embeddedvideopage.xml");
        $this->xmlwriter->begin_tag('activity', array('id' => $instanceid, 'moduleid' => $moduleid,
            'modulename' => 'embeddedvideopage', 'contextid' => $contextid));
        $this->write_xml('embeddedvideopage', $page, array('/embeddedvideopage/id'));
        $this->xmlwriter->end_tag('activity');
        $this->close_xml_writer();

        // write inforef.xml for migrated resource file.
        $this->open_xml_writer("activities/embeddedvideopage_{$moduleid}/inforef.xml");

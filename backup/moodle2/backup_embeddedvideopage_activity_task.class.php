...
/**
 * Defines backup_embeddedvideopage_activity_task class
 *
...
require_once($CFG->dirroot . '/mod/embeddedvideopage/backup/moodle2/backup_embeddedvideopage_stepslib.php');

/**
 * Provides the steps to perform one complete backup of the Page instance
 */
class backup_embeddedvideopage_activity_task extends backup_activity_task {
    ...
    protected function define_my_steps() {
        $this->add_step(new backup_embeddedvideopage_activity_structure_step('page_structure', 'page.xml'));
    }

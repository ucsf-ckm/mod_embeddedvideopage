...
$functions = array(
    ...
    'mod_embeddedvideopage_view_page' => array(
        'classname'     => 'mod_embeddedvideopage_external',
        'methodname'    => 'view_page',
        'description'   => 'Simulate the view.php web interface page: trigger events, completion, etc...',
        'type'          => 'write',
        'capabilities'  => 'mod/embeddedvideopage:view',
        'services'      => array(MOODLE_OFFICIAL_MOBILE_SERVICE)
    ),

    'mod_embeddedvideopage_get_pages_by_courses' => array(
        'classname'     => 'mod_embeddedvideopage_external',

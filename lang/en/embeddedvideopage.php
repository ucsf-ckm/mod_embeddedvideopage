...
/**
 * Strings for component 'embeddedvideopage', language 'en', branch 'MOODLE_20_STABLE'
 *
...
$string['modulename'] = 'Embedded Video Page';
$string['modulename_help'] = 'The embedded video page module enables a teacher to create a web page resource using the text editor. A page can display text, images, sound, video, web links and embedded code, such as Google maps.
...
$string['modulename_link'] = 'mod/embeddedvideopage/view';
$string['modulenameplural'] = 'Embedded Video Pages';
...
$string['pluginadministration'] = 'Embedded Video Page module administration';
$string['pluginname'] = 'Embedded Video Page';
...
$string['privacy:metadata'] = 'The mod_embeddedvideopage plugin does not store any personal data.';
$string['search:activity'] = 'Embedded Video Page';
